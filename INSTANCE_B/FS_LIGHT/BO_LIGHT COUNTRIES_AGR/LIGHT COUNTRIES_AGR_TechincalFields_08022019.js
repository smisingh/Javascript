...
var Tableau = [
	...
	'section102#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Probation Period update (Light countries)',
	//Display Fixed Term Contract
	'section365#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract (Light countries);',
	//Display Termination info
	'section2fecf6651c15581a0c6c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract (Light countries);Involuntary leaver (Light countries)',
	//Display Resignation info
   'section60ceec25b46ed23641b9#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Resignation (Light countries)',
	//Display Last working day
	  'section71c805d9d30258ead277#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Retirement (Light countries);Resignation (Light countries);End of Fixed Term Contract (Light countries);Involuntary leaver (Light countries)',
	//Display Leave of absence details
	'section7a270b6eb274a6748adb#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|LOA Unpaid (Light countries);LOA Paid (Light countries)',
	//Display Return from Leave of Absence
   'section0799b13d6b658217979d#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Return Leave of Absence (Light countries)'
