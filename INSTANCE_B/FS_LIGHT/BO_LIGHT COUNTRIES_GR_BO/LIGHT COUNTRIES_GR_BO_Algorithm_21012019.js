/*
//FS_GR_BO - Algorithm field BACKOFFICE
...
var Tableau = [
	...
	//Display Pay
    'section965#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Pay change (Light countries);Promotion/demotion (Light countries)',
	//Display Work Location
    'section533#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Company change (Light countries)',
	//Display Fixed Term Contract
    'section365#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Fixed term contract extension (Light countries)',
	//Display Contract
    'section786#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Contract change (Light countries)',
	//Display Working hours
    'section3e5b76a8413b1f928001#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Contract change (Light countries)',
	//Display EE Group-Subgroup
    'section258#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Contract change (Light countries)',
	//Display Grade
    'section379#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Grade change (Light countries);Promotion/demotion (Light countries)',
	//Display PU / Cost center
    'section2505e1d2b7faabcdab0f#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Company change (Light countries)',
	//Display Mass Upload
    'section98f0dbc4bb8566749a27#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|Mass Upload (Light countries)'
