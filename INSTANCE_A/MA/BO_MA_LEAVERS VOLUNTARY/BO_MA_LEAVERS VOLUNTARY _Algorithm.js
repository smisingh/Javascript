/*		MA_LEAVERS VOLUNTARY - ALGORITHM - BO
	**************************************************************
Initial version - 1.0
****************************************************************
...
V10.0 - MDKHAN - 24/05/2017
	  - Add Hard Coded French Text in SECTION Population Comparision
*/
...
var Tableau = [
	...
	'section356#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive)',
	
	//Display notification on leaving sections
	'section446#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Confirmed leaving date sections
	'section644#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Voluntary leave(Confirmed);Départ Volontaire (date définitive);International transfer(Confirmed);Transfert international (date définitive)',
	
	//Display Resignation info sections
	'section177#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);International transfer(Confirmed);Transfert international (date définitive);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Fixed term contract sections
	'section652#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Planned leaving date sections
	'section854#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Retirement(Confirmed)sections
	'section920#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle)',
	
	//Display International transfer(Confirmed) sections
	'section612#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|International transfer(Confirmed);Transfert international (date définitive)',
	
	//Not to display planned termination date new for "xx-confirmed"
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR217#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);Retirement(Planned);Retraite (date prévisionnelle);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle);Obligatoire'
	...
	if(document.getElementsByName(FIELD.name+"_radio").length > 0){
		...
		***************************/
		if(FIELD.type == "checkbox"){
			FIELD.checked = false;
			FIELD.value = 0;
		}else if(FIELD.type == "text" || FIELD.type == "select-one"){
			/***************
			VIDER LES CHAMPS
			****************/
			  //vider un champ text - valeur par défaut sur un champ select
			  FIELD.value = "";
		}
	}
};
