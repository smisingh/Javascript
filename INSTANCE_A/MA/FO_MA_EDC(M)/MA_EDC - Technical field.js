/**************		MA EDC Front Office (M) Technical Fields	*************
********************************************************************************
...
window.controlJobFields = function()
{
	var jobField = document.getElementById("INTERVENTIONS_EN_COURS$VALEUR48");
	var fieldValue = jobField.value;
	//disable other fields
            if (fieldValue == "CSS" || fieldValue == "DSP") {
                formulaire.INTERVENTIONS_EN_COURS$VALEUR52.value = "";
                formulaire.INTERVENTIONS_EN_COURS$VALEUR52.disabled = true;
...
window.onloadForm = function() {
	...
	//Change Job Field Preference on Loading
	controlJobFields();
