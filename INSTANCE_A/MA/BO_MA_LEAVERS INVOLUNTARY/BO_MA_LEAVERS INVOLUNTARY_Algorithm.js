...
var Tableau = [
	...
	'section652#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive)',
	
	//Display Planned leaving date sections
	'section854#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
	
	//Display notification on leaving sections
	'section446#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
	
	//Display Confirmed leaving date sections
	'section644#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Involuntary leave(Confirmed);Départ Involontaire (date définitive)',
			
	//Display involuntary section
	'section971#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
		
	//Not to display planned termination date new for "xx-confirmed"
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR217#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Involuntary leave(Planned);Départ Involontaire(date prévisionnelle);Obligatoire'
];
