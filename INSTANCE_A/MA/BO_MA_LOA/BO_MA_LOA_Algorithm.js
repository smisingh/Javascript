...
V2 - PJU - 12/10/2015
	...
	- update function 'champObligatoire(mandatory field)' to work on backoffice
...
V4.0 - PJU - 13-05-2016
	- update 'manageField' & 'affichageChamp(Display fields)' functions : test if label exist before doing action on it
v5.0 - PJU - 18/05/2016
...
var Tableau = [
	...
	//Display Absence start date (new) if Absence start date(current) is not available
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR333#formulaire.UTILISATEURS$CHAMPU310|null'
	//Display Planned Absence end date (new) if Planned absence end date(current) is available
	//'formulaire.INTERVENTIONS_EN_COURS$VALEUR334#formulaire.UTILISATEURS$CHAMPU311|null;différent' 
...
//function display of message in the console if she gets opened
...
/*********************************
FONCTION AFFICHER/MASQUER UN CHAMP/Hide a field
**********************************/
