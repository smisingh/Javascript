/**************		UK-EMPLOYMENT CHANGES  BO Algorithm Fields	**************
	******************************************************************
Developer   - Pierri
Date	    - 14/06/2017
Change No   - MOD-001
...
var Tableau = [
	...
	'section324#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU)',
	//Display Orginization Details sections
	'section953#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU)',
	//Display Local Grade sections
	'section553#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU)',
	//Display Job sections
	'section505#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU);Job',
	//Display Working Hours sections
	'section623#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours',
	//Display Pay sections
	'section804#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours',
	//Display Target Variable sections
	'section805#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours;Cost Centre (PU)',
	//Display Holiday Entitlement sections
	'section721#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours',
	//Display Work Location sections
	'section445#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Work Location',
	//Display Fixed Term Contract sections
	'section978#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Fixed Term Contract Extension',
	//Display Probation Period sections
	'section353#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Probation period extension',
	//Display Management Team sections
	'section472#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Management Team;Cost Centre (PU)',
	//Working hours fields
	//Edited by smita singh on 07/06/2017
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR177#formulaire.INTERVENTIONS_EN_COURS$VALEUR62|Temporary;Trial Period;obligatoire',
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR69#formulaire.INTERVENTIONS_EN_COURS$VALEUR68|NO;obligatoire',
	'formulaire.INTERVENTIONS_EN_COURS$VALEUR95#formulaire.UTILISATEURS$CHAMPU174|Not Eligible;différent;obligatoire'
	//'formulaire.INTERVENTIONS_EN_COURS$VALEUR95#formulaire.UTILISATEURS$CHAMPU93|Not Eligible;différent;obligatoire',
	
	//PayScheme fields
	//'formulaire.INTERVENTIONS_EN_COURS$VALEUR93#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU)'
];
var algorithmField = formulaire.INTERVENTIONS_EN_COURS$VALEUR201;
			...
			if(VALID === false){
				...
				if(BM_VALUES.search(BM_SEARCH) != -1 || BM_CLIENT.search(BM_SEARCH) != -1){
					...
					if(document.getElementById(LBL_FIELD_ID) !== null){
						...
						//remove class to the closest label found
						$(FIELD).closest("tr").find("label").attr("class","label");
					}
				}
				...
				if(algorithmField.value.search(BM_SEARCH) != -1){
					//fill property 'champsobligatoiresproprietes' or 'champsobligatoiresclient' if needed
					if(BM_VALUES.search(BM_SEARCH) == -1 && BM_CLIENT.search(BM_SEARCH) == -1){
						if(BM_VALUES != "" && BM_VALUES != " "){
					...
					//attribute class 'label req'
					if(document.getElementById(LBL_FIELD_ID) !== null){
						document.getElementById(LBL_FIELD_ID).className = "label req";
					}else{
						//attribute class to the closest label found
						$(FIELD).closest("tr").find("label").attr("class","label req");
					}
				}
			}
		}
