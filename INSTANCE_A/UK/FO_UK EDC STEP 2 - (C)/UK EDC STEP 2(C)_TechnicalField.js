/**************		UK EDC STEP 2 (C) FO Technical Fields	***********************
******************************************************************
...
Date	    - 08/06/2017
Change No   - MOD-002
Description - 1) set effective date according to subtopic 
******************************************************************
******************************************************************
Developer   - oriana méril
Date	    - 25/07/2017
Change No   - MOD-003
Description - 1) Replace .value by .innerHTML
******************************************************************
*******************************************************************/
...
window.onloadForm = function(){
	...
	//Cost Center
	popupLink(formulaire.INTERVENTIONS_EN_COURS$VALEUR17,"/Custom_Referential/CostCenter.aspx?Id_Demande=");
	//Community
	popupLink(formulaire.INTERVENTIONS_EN_COURS$VALEUR27,"/Custom_Referential/Specialty.aspx?Id_Demande=");
	//Job Name
	popupLink(formulaire.INTERVENTIONS_EN_COURS$VALEUR46,"/Custom_Referential/JobName.aspx?Id_Demande=");
	//Job Type - inutile ?
	//popupLink(formulaire.UTILISATEURS$CHAMPU178,"/Custom_Referential/JobType.aspx?Id_Demande=");
	//Work Location
	popupLink(formulaire.INTERVENTIONS_EN_COURS$VALEUR123,"/Custom_Referential/SubArea.aspx?Id_Demande=");
	//Management HR
	...
	//Local Grade
	popupLink(formulaire.INTERVENTIONS_EN_COURS$VALEUR41,"/Custom_Referential/LocalGrade.aspx?Id_Demande=");
