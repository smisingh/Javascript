/**************		UK EDC STEP 3 (R) FO Algorithm Fields	**************
******************************************************************
Developer   - 
Date	    - 14/06/2017
Change No   - MOD-001
...
var Tableau = [
	...
	//'section685#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours;Cost Centre (PU)',
...
window.checkIfHide = function () {
  ThisForm.HideSection("section666");
  ThisForm.HideSection("section217");
  ThisForm.HideSection("section136");
  ThisForm.HideSection("section921");
  ThisForm.HideSection("section579");
  ThisForm.HideSection("section813");
  ThisForm.HideSection("section832");
  ThisForm.HideSection("section292");
  ThisForm.HideSection("section842");
  ThisForm.HideSection("section867");
  ThisForm.HideSection("section754");
