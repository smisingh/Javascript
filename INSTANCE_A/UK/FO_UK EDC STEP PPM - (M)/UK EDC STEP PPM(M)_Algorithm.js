/**************		UK EDC STEP 1 (C) FO Algorithm Fields	**************
******************************************************************
Developer   - 
Date	    - 14/06/2017
Change No   - MOD-001
...
var Tableau = [
    ...
    'section993#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours',
	//Display Target Variable sections
    'section28#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Cost Centre (PU);Working hours',
	//Display Target Variable sections
	'section83#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours',
	...
	//test
    //@@Romain 14/08/2017 inter 20237898
    'formulaire.INTERVENTIONS_EN_COURS$VALEUR128#formulaire.INTERVENTIONS_EN_COURS$VALEUR126|null;différent'
	//Change Hours Approved
	//'formulaire.INTERVENTIONS_EN_COURS$VALEUR69#formulaire.INTERVENTIONS_EN_COURS$VALEUR68|NO'
	//Section to diaplay effective date text
	//edited by smita singh on 05/06/2017
    //'section455#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Working hours;Cost Centre (PU);Job;Management Team;Work Location'
...
window.champObligatoire = function(FIELD, VALID){
	if(document.getElementById(FIELD.id)){
		...
		********************************/
		...
		//manage textarea fields
		if(VALIDATOR_FIELD_ID.search("_encoded") != -1){
			VALIDATOR_FIELD_ID = VALIDATOR_FIELD_ID.replace("_encoded","");
		}
...
window.affichageSection = function(SECTION, VALID){
	...
	if(VALID === true){
		...
		for(i=0; i<SECTION_INPUT.length; i++){
			...
			if(SECTION_INPUT[i].id.indexOf('UTILISATEUR') == -1)
			{
		...
		for(s=0; s<SECTION_SELECT.length; s++){
			...
			if(SECTION_SELECT[s].id.indexOf('UTILISATEUR') == -1)
			{
