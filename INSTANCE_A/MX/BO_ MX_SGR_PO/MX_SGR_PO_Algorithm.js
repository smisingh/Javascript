...
Date	    - 07/20/2018 (MM/DD/YYYY)
Change No   - MOD-001
Description - Hide Section based on Subtopics (Mass upload details)
----------------------------------------------------------------------------
Developer   - Smita Singh
Date	    - 07/24/2018 (MM/DD/YYYY)
Change No   - MOD-002
Description - Hide new section i.e. 'Instruction for "Number of children"' and 'Supporting documents for "Number of children"'
			- JS for new subtopics related to personal data
----------------------------------------------------------------------------
Developer   - Riya Dutta
Date	    - 09/26/2018 (MM/DD/YYYY)
Change No   - MOD-003
Description - Hide Section(Assignment Inbound Start details) based on Subtopics
---------------------------------------------------------------------------------*/
/**************************
Fields and display settings
***************************/
var Tableau = [
'section8624ce73504ecd0e86ea#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Bank details', //Personal data Instruction
'sectiond66224d7b9a11d1f2c56#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Bank details', //Personal data Instruction

'section12ba6bc051c40e1ed4a6#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Instruction for "Number of children" -MOD-002-
'section6822fb08e6302f98d77a#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Instruction for "Number of children" -MOD-002-
'section311e7e6f6106272ac647#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Supporting documents for "Number of children" -MOD-002-
'sectione50e2da364591b69dbd8#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Supporting documents for "Number of children" -MOD-002-

'sectiona0ba1102d1586c2ffb49#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Non-Employee deactivation', //Non-Employee deactivation details
'section6c63c8b999cd67f34bed#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Assignment Outbound Start', //Assignment start details
'section9525ef9980a9829c5d71#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound Start', //Assignment Outbound start details
'section7ddfcdb7cf596bd3f705#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound End', //Assignment Outbound end details

'sectionfec7d25b616aa2f9c1e3#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Bank details;MX_Birth and nationality;MX_CURP;MX_Gender;MX_Marital status;MX_Name change;MX_Address;MX_RFC;MX_SSN',//Supporting documents
'section79b509f29d587c67fcb8#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Bank details;MX_Birth and nationality;MX_CURP;MX_Gender;MX_Marital status;MX_Name change;MX_Address;MX_RFC;MX_SSN',//Supporting documents

'section43e3c1ece344c052f523#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound End',//Assignment Inbound end details
'section463cc5c927e8bed521b6#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Cost center change_MU;MX_Grade/job change_MU;MX_Management team_MU;MX_Organisation change_MU;MX_Pay change_MU;MX_Promotion/demotion_MU;MX_Work location transfer_MU',//Mass upload details
'section240cdd5e47500cba3b4a#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Scheduled report',//HR management reporting details
'sectionf361324f894f55fcaeee#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start' //Assignment Inbound Start details
];
