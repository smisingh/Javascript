...
/*--------------------------------------------------------------------------
Developer   - Riya Dutta
Date	    - 08/02/2018 (MM/DD/YYYY)
Change No   - MOD-002
Description - Display Section for MX_Scheduled report
----------------------------------------------------------------------------*/
...
***************************/
var Tableau = [
	//Display Hire/Rehire details
    'section6b5603c767a10abe3c46#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_College Hire;MX_Experienced Hire;MX_Hire with Prior Service;MX_InterCo./CrossCountry Transfer;MX_Non Employee Hire',
	
	//Display section Start Leave of absence details
	'sectionc782b961eab692cab7b9#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Start leave of absence',
	'section69a5aaf1bf501126cf18#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Start leave of absence',
	//Display section Return from LOA details
	'sectionaaaaa4d0fde40bffd946#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Return from LOA',
	 
	//Display section Employment data changes details
	'sectiond602218801c6051703a5#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Work location transfer;MX_Management team',

	  
	//Display section HR mangement reporting details
	'sectiona58787b22cb484b40357#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Scheduled report', //MOD-002

	//Display section Mass upload details
	'sectiona7b9d818e5facbc89a4d#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Cost center change_MU;MX_Grade/job change_MU;MX_Management team_MU;MX_Organisation change_MU;MX_Pay change_MU;MX_Promotion/demotion_MU;MX_Work location transfer_MU',
	
	//New joiner no show details
	'section87f0dba3f9f8f0621b60#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_New joiner no show'
];
