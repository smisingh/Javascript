...
***************************/
var Tableau = [
'section09927d4d249f3e0bd950#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Bank details', //Personal data Instruction

'section26e406386caca57561f2#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Instruction for "Number of children" -MOD-002-

'sectionb062dd60b06289781158#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Supporting documents for "Number of children" -MOD-002-

'section35e2e248e0c5a8fb1a84#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Bank details;MX_Birth and nationality;MX_CURP;MX_Gender;MX_Marital status;MX_Name change;MX_Address;MX_RFC;MX_SSN', //all Personal data subtopics 

'section3e3f8bff241e8fcda1ad#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Non-Employee deactivation', //Non-Employee deactivation details

'section629e984bd4e64b4cb967#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Assignment Outbound Start', //Assignment start details

'section49bbd2411f7ecbced2a5#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound Start', //Assignment Outbound start details

'section21710f6226e3d19f769b#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound End', //Assignment Outbound end details

'section0dd85d7de9560abc59d3#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound End',//Assignment Inbound end details

'sectionae2c2777d1d50141fbab#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Cost center change_MU;MX_Grade/job change_MU;MX_Management team_MU;MX_Organisation change_MU;MX_Pay change_MU;MX_Promotion/demotion_MU;MX_Work location transfer_MU'//Mass upload details
