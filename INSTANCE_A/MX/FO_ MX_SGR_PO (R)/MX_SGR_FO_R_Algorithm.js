...
Date	    - 07/19/2018 (MM/DD/YYYY)
Change No   - MOD-001
Description - Hide Section based on Subtopics
-------------------------------------------------------------------------
Developer   - Smita Singh
Date	    - 07/25/2018 (MM/DD/YYYY)
Change No   - MOD-002
Description -  Add 2 new section for Instruction for "Number of children" and Supporting documents for "Number of children"
			- Add new subtopics replacing dummy personal data
----------------------------------------------------------------------------*/
/**************************
Fields and display settings
***************************/
var Tableau = [
'sectionf8ce1eb6b8a2f2533707#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Bank details', //Personal data Instruction
'section679c66dec3ac253961b8#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Instruction for "Number of children" -MOD-002-
'sectionb68dacd28cbd4f361ddc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Number of children', //Supporting documents for "Number of children" -MOD-002-

'sectionc443e2f182dd4dbe0f1c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Non-Employee deactivation', //Non-Employee deactivation details
'section5cb19e4490fb99a4d503#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Assignment Outbound Start', //Assignment start details
'section36cc0dfd4d5674e3e09c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound Start', //Assignment Outbound start details
'section1c5009e617275e4d70b7#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Outbound End', //Assignment Outbound end details

'sectionf5da2c3d7695c49d8608#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound Start;MX_Bank details;MX_Birth and nationality;MX_CURP;MX_Gender;MX_Marital status;MX_Name change;MX_Address;MX_RFC;MX_SSN',//Supporting documents

'section062df86ec22bb9716a22#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Assignment Inbound End',//Assignment Inbound end details
'sectionff6dbf6cb6964d3ac03f#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Cost center change_MU;MX_Grade/job change_MU;MX_Management team_MU;MX_Organisation change_MU;MX_Pay change_MU;MX_Promotion/demotion_MU;MX_Work location transfer_MU',//Mass upload details
'section59490b9d1786f0bc4e99#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|MX_Scheduled report'//HR management reporting details'
